...
with st.sidebar:
    ...
    if editable:
        ...
        st.caption("Sign in to enable auto-refresh. Market Breadth is never auto-refreshed.")
        st.session_state["auto_refresh_stocks"] = False
        st.session_state["auto_refresh_kline"] = False
        auto_refresh_stocks = False
        auto_refresh_kline = False
        auto_refresh_interval_minutes = int(st.session_state.get("auto_refresh_interval_minutes", 5))
